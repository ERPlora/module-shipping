...
@login_required
@htmx_view('shipping/pages/carrier_add.html', 'shipping/partials/carrier_add_content.html')
def carrier_add(request):
    ...
    if request.method == 'POST':
        ...
        response['HX-Redirect'] = reverse('shipping:carriers_list')
        return response
    return {}

@login_required
@htmx_view('shipping/pages/carrier_edit.html', 'shipping/partials/carrier_edit_content.html')
...
@login_required
@permission_required('shipping.manage_settings')
